...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("SOURCEVEGA")
                await self.one.join_chat("GROUP_VEGA")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("T_Y_E_X")
                await self.two.join_chat("UI_VM")
                await self.two.join_chat("UX_OU")
            except:
                pass
            assistants.append(2)
            try:
