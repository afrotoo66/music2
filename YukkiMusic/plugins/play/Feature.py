...
@app.on_message(
    command(["مميزات","مميزات عفرتو"])
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس عفرتو ميوزك\n
ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛
            ...
            [
                [
                    InlineKeyboardButton(
                        "ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛", url=f"https://t.me/T_Y_E_X"),                        
                 ],[
                InlineKeyboardButton(
                        "◁", callback_data="close"),
               ],
