...
GAME_MESSAGE = "ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب عفرتو\n\n⩹ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('★¦العاب فيجاا', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾, url =f"https://t.me/T_Y_E_X")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛\n\nمرحبا بك في قسم العاب فيجا 3D\n\nᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛\n\n★¦مرحبا بك في قسم العاب فيجا\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\nᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب عفرتو', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('ŚŐÚŔŚ ÁŦŔŐŤŐŐ  ', url =f"https://t.me/T_Y_E_X")              
                 ],[
                InlineKeyboardButton(
                        "◁", callback_data="close"),
               ],
